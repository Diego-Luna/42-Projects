...
/*   Updated: 2023/02/23 14:26:14 by dluna-lo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Constructors
Form::Form(void) : _name("NONE"), _signed(false), _gradeSingIn(150), _gradeExecute(150) {
	std::cout << "Form default constructor called" << std::endl;
	return;
}

Form::Form(std::string const & _name, int _gradeSingIn, int _gradeExecute): _name(_name), _signed(false), _gradeSingIn(_gradeSingIn), _gradeExecute(_gradeExecute) {
